...
class Descriptor(ABC):
    ...
    def get_dim_rot_mat_1(self) -> int:
        ...
        # polar fitting network. However, currently not all descriptors have this method.
    ...
    def get_nlist(self) -> Tuple[tf.Tensor, tf.Tensor, List[int], List[int]]:
        ...
        """
        # TODO: I think this method should be implemented as it's called by energy model.
        # However, se_ar and hybrid doesn't have this method.
        raise NotImplementedError
    ...
    def compute_input_stats(self,
        ...
        ----------
        data_coord : list[np.ndarray]
            The coordinates. Can be generated by :meth:`deepmd.model.make_stat_input`
        data_box : list[np.ndarray]
            The box. Can be generated by :meth:`deepmd.model.make_stat_input`
        data_atype : list[np.ndarray]
            The atom types. Can be generated by :meth:`deepmd.model.make_stat_input`
        natoms_vec : list[np.ndarray]
            The vector for the number of atoms of the system and different types of atoms. Can be generated by :meth:`deepmd.model.make_stat_input`
        mesh : list[np.ndarray]
            The mesh for neighbor searching. Can be generated by :meth:`deepmd.model.make_stat_input`
        input_dict : dict[str, list[np.ndarray]]
