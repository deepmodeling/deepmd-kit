...
from deepmd.utils.type_embed import Type_embed_net

class DescrptSeAEbd_type ():
    def __init__ (self, 
                  rcut: float,
                  rcut_smth: float,
                  sel: List[str],
        ...
        self.type_embed_net = Type_embed_net(self.ntypes,type_filter,resnet_dt,seed, activation_function,precision)
    ...
    def _share_embedding_net_twoside(self, 
        ...
        with tf.variable_scope(name, reuse=reuse):
            ...
            nei_embed = self.type_embed_net._type_embed( self.nei_type,
                                        reuse = reuse,
                                        trainable = True,
                                        suffix = '') #nnei*nchnl
            atm_embed = self.type_embed_net._type_embed( atype,
                                        reuse = True,
                                        trainable = True,
    ...
    def _pass_filter(self, 
        ...
        layer, qmat = self._share_filter(tf.cast(inputs, self.filter_precision), 
                                       atype,
                                       natoms,
                                       input_dict,
    ...
    def _share_filter(self, 
        ...
        if self.type_one_side:
          mat_g = self._share_embedding_net_oneside(inputs,
                                    natoms,
                                    atype,
                                    nframes,
                                    self.filter_neuron, 
          ...
          mat_g = self._share_embedding_net_twoside(inputs,
                                    natoms,
                                    atype,
                                    nframes,
                                    self.filter_neuron, 
