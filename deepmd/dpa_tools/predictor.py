...
from deepmd.dpa_tools.conditions import DPAConditionError
...
class DPAPredictor:
    ...
    def __init__(self, model_path: str, n_committee: int = 1):
        ...
        from deepmd.dpa_tools.finetuner import DPAFineTuner
    ...
    def fit(self, data, target_key=None, labels=None, fmt=None, conditions=None):
        ...
        from deepmd.dpa_tools.conditions import ConditionManager
        from deepmd.dpa_tools.finetuner import _load_labels
