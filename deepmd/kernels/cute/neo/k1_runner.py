...
"""Runtime runner for the Neo CuTe K1 SO2 unit."""
...
class _NeoK1BackwardWorkspaceBase:
    _EXPORTED_NAMES = (
        "grad_stack_focus",
        "grad_focus_alpha",
        "grad_dt",
...
class NeoK1BackwardWorkspace(_NeoK1BackwardWorkspaceBase):
    """Lazily allocated K1 backward scratch with lifetime-based slab reuse."""
    ...
    def __init__(
        ...
        *,
        ...
        if d_values_per_edge > 10 * 64:
            raise ValueError("Neo K1 grad_D does not fit the Phase-C scratch slab")
...
class NeoFullCuteBackward:
    def __init__(
        ...
        *,
        ...
        from .k1_kernels.cute_envelope_gated_softmax import (
            compile_envelope_softmax_forward,
        )
        from .k1_kernels.cute_neo_phase_a_radial_forward import (
        ...
        if (
            ...
            raise ValueError(
                f"packed Neo K1 Wigner tensors must have shape {expected_shape}"
            )
        if d_full.data_ptr() != dt_full.data_ptr():
            raise ValueError("packed Neo K1 D and Dt must share one storage")
        ...
        from .k1_kernels.cute_neo_focus_src_backward import (
        ...
        from .k1_kernels.cute_neo_qk_edge import (
        ...
        if runtime_config.combined_so2_gate:
            from .k1_kernels.cute_neo_gate_linear_residual_backward_fused import (
            ...
            from .k1_kernels.cute_neo_gate_split_structural_vec4_sm80 import (
    ...
    def _build_forward_graph(self) -> None:
        ...
        if self.config.combined_so2_gate:
            from .k1_kernels.cute_neo_so2_gate_combined_fwd import (
