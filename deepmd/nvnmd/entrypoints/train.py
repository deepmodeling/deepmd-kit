...
def normalized_input_qnn(jdata, PATH_QNN, CONFIG_CNN, WEIGHT_CNN, MAP_CNN):
    ...
    jdata2 = jdata1.copy()
    jdata2 ['start_lr'] = 1e-12
    jdata2 ['stop_lr'] = 1e-12
...
def train_nvnmd(
    ...
    #
    PATH_CNN = 'nvnmd_cnn'
    CONFIG_CNN = PATH_CNN+'/config.npy'
    INPUT_CNN = PATH_CNN+'/train.json'
    WEIGHT_CNN = PATH_CNN+'/weight.npy'
    FRZ_MODEL_CNN = PATH_CNN+'/frozen_model.pb'
    MAP_CNN = PATH_CNN+'/map.npy'
    #
    PATH_QNN = 'nvnmd_qnn'
    CONFIG_QNN = PATH_QNN+'/config.npy'
    INPUT_QNN = PATH_QNN+'/train.json'
    WEIGHT_QNN = PATH_QNN+'/weight.npy'
    FRZ_MODEL_QNN = PATH_QNN+'/frozen_model.pb'
    MODEL_QNN = PATH_QNN+'/model.pb'
