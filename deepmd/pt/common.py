...
"""Common functionality shared across PyTorch descriptor implementations."""
...
class ComputeInputStatsMixin:
    """Mixin class providing common compute_input_stats implementation for PyTorch backend.
    ...
    def _set_stat_mean_and_stddev(self, mean, stddev) -> None:
        ...
        tensor assignment logic for PyTorch backend.
