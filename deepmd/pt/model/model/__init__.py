...
def _resolve_sezm_fitting_neuron(fitting_net: dict, descriptor: BaseDescriptor) -> None:
    """Resolve SeZM fitting hidden widths in-place."""
...
def get_sezm_model(model_params: dict) -> BaseModel:
    ...
    fitting_net["mixed_types"] = descriptor.mixed_types()
    fitting_net["dim_descrpt"] = descriptor.get_dim_out()
    _resolve_sezm_fitting_neuron(fitting_net, descriptor)
    ...
    enable_tf32 = bool(model_params.get("enable_tf32", False))
