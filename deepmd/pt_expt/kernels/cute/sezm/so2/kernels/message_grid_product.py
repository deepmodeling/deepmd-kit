...
"""Packed strict-FP32 CuTe grid product for Neo's F=2 SO2 branch."""
...
def _make_grid_operation(
    ...
    *,
    ...
    from ...output_grid.kernels import tiled_product as tiled
...
def compile_message_grid_product_forward(
    ...
    from ...output_grid.kernels.tiled_product import (
