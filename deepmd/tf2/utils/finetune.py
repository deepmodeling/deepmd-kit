...
"""Fine-tuning config utilities for the TensorFlow 2 backend."""
...
def _load_model_params(finetune_model: str) -> dict[str, Any]:
    """Extract model params from a TF2 training checkpoint."""
...
def get_finetune_rules(
    ...
    """Build TF2 fine-tuning rules for single-task or multi-task configs."""
