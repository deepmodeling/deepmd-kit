...
def fitting_ener():
    ...
    doc_numb_dataid = "The dimension of the data identification embedding. When training or fine-tuning a multitask model with data identification embeddings, this number should be set to the number of model branches."
...
- list of bool{doc_only_tf_supported}: Specifies if each layer is trainable. Since the fitting net is composed by hidden layers followed by a output layer, the length of this list should be equal to len(`neuron`)+1."
    ...
    return [
        ...
        Argument(
            ...
            optional=True,
            default=0,
            doc=doc_only_pt_supported + doc_numb_dataid,
        ),
        Argument(
            "neuron",
            list[int],
