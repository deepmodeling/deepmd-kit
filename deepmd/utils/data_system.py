...
from deepmd.utils.data_mt import DeepmdData_mt
...
class DeepmdDataDocker() :
    ...
    def __init__ (self,
        ...
        for ii in range(self.nmethod) :
            ...
            name_list.extend(self.data_systems[ii].get_name())
