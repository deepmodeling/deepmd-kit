...
[LAMMPS module](../third-party/lammps-command.md) and [i-Pi](../third-party/ipi.md) are only provided on Linux and macOS. To install LAMMPS and/or i-Pi, add `lmp` and/or `ipi` to extras:
```bash
