...
```
The source code of LAMMPS is stored in directory `lammps-stable_23Jun2022_update2`. Now go into the LAMMPS code and copy the DeePMD-kit module like this
```bash
...
The source code of LAMMPS is stored in directory `lammps-stable_23Jun2022_update2`. The directory of the source code should be specified as the CMAKE argument `LAMMPS_SOURCE_ROOT` during installation of the DeePMD-kit C++ interface. Now go into the LAMMPS directory and create a directory called `build`
