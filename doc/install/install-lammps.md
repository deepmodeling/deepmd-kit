...
```bash
cd /some/workspace
wget https://github.com/lammps/lammps/archive/stable_29Sep2021_update1.tar.gz
tar xf stable_29Sep2021_update1.tar.gz
```
The source code of LAMMPS is stored in directory `lammps-stable_29Sep2021_update1`. Now go into the LAMMPS code and copy the DeePMD-kit module like this
```bash
cd lammps-stable_29Sep2021_update1/src/
...
tar xf stable_29Sep2021_update1.tar.gz
```
The source code of LAMMPS is stored in directory `lammps-stable_29Sep2021_update1`. Now go into the LAMMPS code and create a directory called `build`
```bash
mkdir -p lammps-stable_29Sep2021_update1/build/
cd lammps-stable_29Sep2021_update1/build/
```
