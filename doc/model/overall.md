...
2. [`ener_spin`](train-energy-spin.md): Fit the energy of the spin system. The atomic force and the magnetic force can also be trained.
3. [`dipole`](train-fitting-tensor.md): The dipole moment.
4. [`polar`](train-fitting-tensor.md): The polarizability.
