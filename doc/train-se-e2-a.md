...
* If the option `type_one_side` is set to `true`, then descriptor will only use information of neighbor atom when generating description. While `false` means using both centric atom and neighbor atom information.
