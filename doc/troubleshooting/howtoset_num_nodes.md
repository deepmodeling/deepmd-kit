...
:::{tab-item} PyTorch-TorchScript and PyTorch-Exportable {{ pytorch_icon }}

Multiprocessing support for training in the PyTorch-TorchScript and
PyTorch-Exportable backends is implemented with [torchrun](https://pytorch.org/docs/stable/elastic/run.html).
:::
