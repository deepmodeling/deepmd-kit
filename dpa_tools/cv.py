...
from dpa_tools.data.loader import _get_source, _resolve_label_key
...
def _assemble_from_per_system_cache(
    ...
    y : np.ndarray (1D)
    """
    from dpa_tools.data.desc_cache import get_per_system_descriptor
    X_list, y_list = [], []
...
def cross_validate(
    ...
    if is_cheap:
        from dpa_tools.data.desc_cache import ensure_per_system_cache
