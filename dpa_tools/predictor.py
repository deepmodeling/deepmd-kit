# dpa_tools/predictor.py

import numpy as np

from dpa_tools.conditions import DPAConditionError
from dpa_tools.data.loader import load_data
from dpa_tools.utils.dotdict import DotDict
...
class DPAPredictor:
    ...
    def __init__(self, model_path: str, n_committee: int = 1):
        from dpa_tools._backend import load_torch_file
        ...
        if "predictor" in bundle and "pooling" not in bundle:
            raise ValueError(
                "This model was frozen with dpa_tools <0.2. "
        ...
        from dpa_tools.finetuner import DPAFineTuner
    ...
    def fit(self, data, target_key=None, labels=None, fmt=None, conditions=None):
        ...
        from dpa_tools.conditions import ConditionManager
        from dpa_tools.finetuner import _load_labels
