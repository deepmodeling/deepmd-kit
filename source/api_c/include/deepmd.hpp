...
// support spin
template <typename FPTYPE>
inline void _DP_DeepPotComputeSP(DP_DeepSpin *dp,
                                 const int nframes,
                                 const int natom,
                                 const FPTYPE *coord,
                                 const FPTYPE *spin,
...
template <>
inline void _DP_DeepPotComputeSP<double>(DP_DeepSpin *dp,
                                         const int nframes,
                                         const int natom,
                                         const double *coord,
                                         const double *spin,
...
template <>
inline void _DP_DeepPotComputeSP<float>(DP_DeepSpin *dp,
                                        const int nframes,
                                        const int natom,
                                        const float *coord,
                                        const float *spin,
...
template <typename FPTYPE>
inline void _DP_DeepPotModelDeviComputeNListSP(DP_DeepSpinModelDevi *dp,
                                               const int natom,
                                               const FPTYPE *coord,
                                               const FPTYPE *spin,
                                               const int *atype,
                                               ...
                                               FPTYPE *atomic_virial);
template <>
inline void _DP_DeepPotModelDeviComputeNListSP<double>(DP_DeepSpinModelDevi *dp,
                                                       const int natom,
                                                       const double *coord,
                                                       const double *spin,
                                                       const int *atype,
...
template <>
inline void _DP_DeepPotModelDeviComputeNListSP<float>(DP_DeepSpinModelDevi *dp,
                                                      const int natom,
                                                      const float *coord,
                                                      const float *spin,
                                                      const int *atype,
