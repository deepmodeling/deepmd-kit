...
public:
  template<typename VALUETYPE> void compute (std::vector<VALUETYPE> &		dfcorr_,
...
private:
  ...
  template<typename MODELTYPE, typename VALUETYPE> void run_model (std::vector<VALUETYPE> &		dforce,
