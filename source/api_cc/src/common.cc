...
template void deepmd::select_real_atoms_coord<double>(std::vector<double>& dcoord,
                       std::vector<int>& datype,
...
template void deepmd::select_real_atoms_coord<float>(std::vector<float>& dcoord,
                       std::vector<int>& datype,
