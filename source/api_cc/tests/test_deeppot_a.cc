...
protected:  
  ...
  std::vector<float>expected_tot_v;

  deepmd::PaddleDeepPot dp;

  void SetUp() override {
    dp.init ("/home/paddle-deepmd/setting/lmp/model.pdmodel", "/home/paddle-deepmd/setting/lmp/model/pdiparams");
