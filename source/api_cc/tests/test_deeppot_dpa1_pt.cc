...
namespace {
// Reference values come from source/tests/infer/deeppot_dpa1.expected, which
// gen_dpa1.py regenerates at CI time alongside the .pth/.pt2 model files.
constexpr const char* kRefPath = "../../tests/infer/deeppot_dpa1.expected";
constexpr const char* kModelPath = "../../tests/infer/deeppot_dpa1.pth";
}  // namespace
