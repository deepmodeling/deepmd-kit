...
namespace {
// Reference values come from source/tests/infer/deeppot_dpa3.expected, which
// gen_dpa3.py regenerates at CI time alongside the .pth/.pt2 model files.
constexpr const char* kRefPath = "../../tests/infer/deeppot_dpa3.expected";
constexpr const char* kModelPath = "../../tests/infer/deeppot_dpa3.pth";
}  // namespace
