...
// Test C++ inference for pt_expt (.pt2) backend with DPA3 (mixed-type) model.
...
// DPA3 models need relaxed epsilon (same as test_deeppot_dpa3_pt.cc)
#undef EPSILON
#define EPSILON (std::is_same<VALUETYPE, double>::value ? 1e-10 : 1e-4)

namespace {
constexpr const char* kRefPath = "../../tests/infer/deeppot_dpa3.expected";
constexpr const char* kModelPath = "../../tests/infer/deeppot_dpa3.pt2";
}  // namespace

template <class VALUETYPE>
class TestInferDeepPotDpa3PtExpt : public ::testing::Test {
 protected:
...
TYPED_TEST(TestInferDeepPotDpa3PtExpt, cpu_build_nlist) {
...
TYPED_TEST(TestInferDeepPotDpa3PtExpt, cpu_build_nlist_numfv) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
  ...
  class MyModel : public EnergyModelTest<VALUETYPE> {
   ...
   public:
    MyModel(deepmd::DeepPot& dp_, const std::vector<int>& atype_)
      ...
      // DPA3 needs relaxed numfv tolerance (consistent with Python places=5)
...
TYPED_TEST(TestInferDeepPotDpa3PtExpt, cpu_build_nlist_atomic) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
...
TYPED_TEST(TestInferDeepPotDpa3PtExpt, cpu_lmp_nlist) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
...
TYPED_TEST(TestInferDeepPotDpa3PtExpt, cpu_lmp_nlist_atomic) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
...
TYPED_TEST(TestInferDeepPotDpa3PtExpt, cpu_lmp_nlist_2rc) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
...
TYPED_TEST(TestInferDeepPotDpa3PtExpt, cpu_lmp_nlist_type_sel) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
...
TYPED_TEST(TestInferDeepPotDpa3PtExpt, print_summary) {
  deepmd::DeepPot& dp = this->dp;
  dp.print_summary("");
}
...
// ---- NoPbc fixture (box = {}) ----
template <class VALUETYPE>
class TestInferDeepPotDpa3PtExptNoPbc : public ::testing::Test {
 protected:
  std::vector<VALUETYPE> coord = {12.83, 2.56, 2.18, 12.09, 2.87, 2.74,
                                  00.25, 3.32, 1.68, 3.36,  3.00, 1.81,
                                  3.51,  2.51, 2.60, 4.27,  3.22, 1.56};
...
TYPED_TEST(TestInferDeepPotDpa3PtExptNoPbc, cpu_build_nlist) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
...
TYPED_TEST(TestInferDeepPotDpa3PtExptNoPbc, cpu_lmp_nlist) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
