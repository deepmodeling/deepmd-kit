...
class TestInferDeepPotDpaPd : public ::testing::Test {
 protected:
  ...
  void SetUp() override {
    dp.init("../../tests/infer/deeppot_dpa.json");
...
TYPED_TEST_SUITE(TestInferDeepPotDpaPd, ValueTypes);

TYPED_TEST(TestInferDeepPotDpaPd, cpu_build_nlist) {
...
TYPED_TEST(TestInferDeepPotDpaPd, cpu_build_nlist_atomic) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
...
template <class VALUETYPE>
class TestInferDeepPotDpaPdNopbc : public ::testing::Test {
 protected:
  std::vector<VALUETYPE> coord = {12.83, 2.56, 2.18, 12.09, 2.87, 2.74,
                                  00.25, 3.32, 1.68, 3.36,  3.00, 1.81,
                                  3.51,  2.51, 2.60, 4.27,  3.22, 1.56};
...
TYPED_TEST_SUITE(TestInferDeepPotDpaPdNopbc, ValueTypes);

TYPED_TEST(TestInferDeepPotDpaPdNopbc, cpu_build_nlist) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
...
TYPED_TEST(TestInferDeepPotDpaPdNopbc, cpu_build_nlist_atomic) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
...
TYPED_TEST(TestInferDeepPotDpaPdNopbc, cpu_lmp_nlist) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
...
TYPED_TEST(TestInferDeepPotDpaPdNopbc, cpu_lmp_nlist_atomic) {
  using VALUETYPE = TypeParam;
  std::vector<VALUETYPE>& coord = this->coord;
  std::vector<int>& atype = this->atype;
  std::vector<VALUETYPE>& box = this->box;
