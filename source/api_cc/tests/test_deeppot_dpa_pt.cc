...
class TestInferDeepPotDpaPt : public ::testing::Test {
 protected:
  ...
  std::vector<VALUETYPE> expected_e = {-92.764905689986,  -186.094047026640,
                                       ...
                                       -185.718629663486, -186.890683867854};
  std::vector<VALUETYPE> expected_f = {
      ...
      -0.538259022526, 5.229560416553,  -0.179736171347, 0.656841281775,
      2.176588439569,  1.058704155488,  -1.470879889720, -1.816978045627,
      -0.509887139982, 0.677599395809};
