...
if(NOT TensorFlowFramework_FIND_COMPONENTS)
  if(WIN32)
    if(TENSORFLOW_VERSION VERSION_GREATER_EQUAL 2.20)
      ...
      # _pywrap_tensorflow_common.dll.if.lib is given
      set(TensorFlowFramework_FIND_COMPONENTS _pywrap_tensorflow_common)
    else()
...
if(WIN32)
  ...
  list(APPEND CMAKE_FIND_LIBRARY_SUFFIXES .dll.if.lib)
elseif(APPLE)
  list(APPEND CMAKE_FIND_LIBRARY_SUFFIXES .2.dylib)
else()
  list(APPEND CMAKE_FIND_LIBRARY_SUFFIXES .so.1)
