...
cd ${BUILD_TMP_DIR}
cmake -DCMAKE_INSTALL_PREFIX=${INSTALL_PREFIX} -DINSTALL_TENSORFLOW=${DOWNLOAD_TENSORFLOW} ${CUDA_ARGS} -DLAMMPS_VERSION=stable_23Jun2022_update1 -DUSE_TTM=TRUE -DBUILD_TESTING:BOOL=TRUE ..
make -j${NPROC}
make install
