    ...
    const float & rmax)
{
  if (xx < rmin) {
    ...
    FPTYPE du = (FTYPE)1. / (rmax - rmin) ;
    vv = uu*uu*uu * ((FTYPE)-6. * uu*uu + (FTYPE)15. * uu - (FTYPE)10.) + (FTYPE)1.;
    dd = ( (FTYPE)3. * uu*uu * ((FTYPE)-6. * uu*uu + (FTYPE)15. * uu - (FTYPE)10.) + uu*uu*uu * ((FTYPE)-12. * uu + (FTYPE)15.) ) * du;
  }
  else {
    dd = (FTYPE)0.;
    vv = (FTYPE)0.;
