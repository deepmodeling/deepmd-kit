...
pb_file = Path(__file__).parent.parent.parent / "tests" / "infer" / "deeppot_sea.json"
...
def setup_module():
    pytest.skipIf(os.environ.get("ENABLE_PADDLE", "1") != "1", "Skip test because Paddle support is not enabled.")
