...
{
public:
    explicit ProdForceSeAMaskGradOp(OpKernelConstruction *context) : OpKernel(context)
    {
    ...
    void _Compute(OpKernelContext *context)
    {
        ...
        OP_REQUIRES(context, (mask_shape.dims() == 2), errors::InvalidArgument("Dim of mask should be 2"));
        ...
        OP_REQUIRES(context, (nframes == mask_shape.dim_size(0)), errors::InvalidArgument("number of frames should match"));
