...
class SoftMinForceGradOp : public OpKernel {
 public:
  ...
  void _Compute(OpKernelContext* context) {
    ...
    OP_REQUIRES(
        context, (sw_deriv_shape.dims() == 2),
        deepmd::tf_compat::InvalidArgument("Dim of sw deriv should be 2"));
    ...
    OP_REQUIRES(
        context, (nframes == sw_deriv_shape.dim_size(0)),
        deepmd::tf_compat::InvalidArgument("number of frames should match"));
    OP_REQUIRES(
    ...
    OP_REQUIRES(
        ...
        deepmd::tf_compat::InvalidArgument("number of sw deriv should match"));
    OP_REQUIRES(
