...
from deepmd.dpa_tools.data.desc_cache import (
    _data_fingerprint,
    _cache_key,
    _cache_dir,
...
class TestEnsurePerSystemCache:
    ...
    def test_all_cached_does_not_load_model(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "deepmd.dpa_tools.finetuner.DPAFineTuner", FakeFineTuner,
        )
        ensure_per_system_cache(
