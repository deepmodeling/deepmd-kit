...
def test_finetuner_fparam_forwarded_to_trainer():
    ...
    with patch("dpa_tools.trainer.DPATrainer") as mock_trainer_cls:
...
def test_cli_fparam_dim_parsed():
    ...
    from dpa_tools.cli import get_parser
...
def test_mft_fparam_validate_called_on_fit():
    ...
    with patch("dpa_tools.trainer.DPATrainer._validate_fparam") as mock_validate, \
         patch("dpa_tools.config.manager.MFTConfigManager") as mock_cm_class, \
         patch("dpa_tools.mft.subprocess.Popen") as mock_popen:
