...
def main():
    ...
    pth_default_exported = False
    print(f"Exporting to {pth_default_path} ...")  # noqa: T201
    try:
        pt_deserialize_to_file(pth_default_path, copy.deepcopy(data_default))
        pth_default_exported = True
    except RuntimeError as e:
        print(f"WARNING: .pth default export failed ({e}), skipping.")  # noqa: T201
