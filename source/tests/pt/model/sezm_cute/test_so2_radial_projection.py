...
from deepmd.pt_expt.kernels.cute.sezm.so2 import radial_phase_a as _RADIAL_PROJECTION
...
_batched_radial_projection_weight = _SO2_RUNNER._batched_radial_projection_weight
