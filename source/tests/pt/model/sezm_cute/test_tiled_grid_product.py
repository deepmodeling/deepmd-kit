...
TILED_KERNEL_PATH = CUTE_ROOT / "output_grid" / "kernels" / "tiled_product.py"
MESSAGE_GRID_PATH = CUTE_ROOT / "so2" / "kernels" / "message_grid_product.py"
...
class TestTiledOutputGridProductForwardCuda:
    ...
    def test_matches_strict_fp32_reference(
        ...
        from deepmd.pt_expt.kernels.cute.sezm.output_grid.kernels.tiled_product import (
