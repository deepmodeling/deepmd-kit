...
class TestConsistency(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.all_stat["find_atomic_polarizability"] = self.all_stat.pop("find_atom_polarizability")
        self.all_stat["atomic_polarizability"] = self.all_stat.pop("atom_polarizability")
