...
class TestInitFrzModelA(unittest.TestCase):
    ...
    def tearDownClass(self):
        ...
        _file_delete("init_frz_se_a.ckpt.meta")
        _file_delete("init_frz_se_a.ckpt.index")
        _file_delete("init_frz_se_a.ckpt.data-00000-of-00001")
        _file_delete("init_frz_se_a.ckpt-0.meta")
        _file_delete("init_frz_se_a.ckpt-0.index")
        _file_delete("init_frz_se_a.ckpt-0.data-00000-of-00001")
        _file_delete("init_frz_se_a.ckpt-1.meta")
        _file_delete("init_frz_se_a.ckpt-1.index")
        _file_delete("init_frz_se_a.ckpt-1.data-00000-of-00001")
